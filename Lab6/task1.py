...
commands = ["Додати книгу", "Видалити книгу", "Знайти книгу за ID", "Знайти книгу", "Стоп",
            "Висвітити всі книги", ]
...
class Library():
    ...
    def search_book(self, query_dict):
        ...
        if(len(found_books) == 0):
            print("Вибачте, але ми не знайшли цю книгу")
        else:
